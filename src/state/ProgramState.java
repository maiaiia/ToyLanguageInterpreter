...
import state.lockTable.ILockTable;
...
public class ProgramState {
    ...
    public ProgramState(ISymbolTable symbolTable, IExecutionStack executionStack, IOutput output, IFileTable fileTable, IHeap heap, ILockTable lockTable, IStatement originalProgram) {
