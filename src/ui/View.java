...
import state.latchTable.CountDownLatchTable;
...
public class View  {
    static private TextMenu getMenu() {
        ...
        for (int i = 0; i < statements.size(); i++) {
            ...
            ProgramState p = new ProgramState(new SymbolTable(), new ExecutionStack(), new Output(), new FileTable(), new Heap(), new CountDownLatchTable(), statements.get(i));
